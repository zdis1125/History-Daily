...
model_list <- list(
  ...
  svm2    = function(x,y) svm(x, y, type = "eps-regression",kernel = "radial", cost = 100, gamma =.1, epsilon = 10),
  svm4    = function(x,y) svm(x, y, type = "eps-regression",kernel = "radial", cost = 100, gamma =.1, epsilon = 3),
  svm5    = function(x,y) svm(x, y, type = "eps-regression",kernel = "radial", cost = 10, gamma =.1, epsilon = 1),
  svm6    = function(x,y) svm(x, y, type = "eps-regression",kernel = "radial", cost = 1, gamma =.1, epsilon = 1),
  svm7    = function(x,y) svm(x, y, type = "eps-regression",kernel = "radial", cost = .1, gamma =.1, epsilon = 1),
  svm8    = function(x,y) svm(x, y, type = "eps-regression",kernel = "radial", cost = 10, gamma =1, epsilon = 1),
  svm9    = function(x,y) svm(x, y, type = "eps-regression",kernel = "radial", cost = 10, gamma =10, epsilon = 1),
  svm10    = function(x,y) svm(x, y, type = "eps-regression",kernel = "radial", cost = 10, gamma =.100, epsilon = 1),
